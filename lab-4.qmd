...
```{r}
# I didn't have the data for this question, so I put  the code I would've 
#used below. I tried putting this in a code chunk and set error: false, 
#but I still couldn't render the document, so  hopefully this is okay.
...
```{r}
#Same comment as previous question, error: false didn't work to let me 
#render the document, but this is the code I would've done for the 
...
#ggplot(survey_summary, aes(x = reorder(service, desc(pct)), 
  #y = pct, fill = #sector_preference)) +
#  geom_col() +
#  coord_flip() +
...
#  labs(
#    title = "Q4. Do you think the following services should be run in\n
# the private sector or public sector?",
#    caption = "Respondents unweighted. Total=1858 \n 
