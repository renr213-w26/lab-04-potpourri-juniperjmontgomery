...
#```{r}
# I didn't have the data for this question, so I put  the code I would've used below. I tried putting this in a code chunk and set error: false, but I still couldn't render the document, so  hopefully this is still okay.
...
#```{r}
#Same comment as previous question, error: false didn't work to let me render the document, but this is the code I would've done for the question if I had the data.
